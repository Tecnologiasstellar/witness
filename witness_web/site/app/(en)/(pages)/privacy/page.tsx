...
const SECTIONS: [string, string[]][] = [
  ["This website", ["This website uses Vercel Analytics. It uses no account, email capture, advertising, or cookies. It serves public pages, original illustrations, and one audio sample. The same is true of the publication at community.witnessatlas.com, which adds an RSS feed; its email edition, where offered, is a link to a separate provider's page, and that provider holds the address under its own terms. On the map page, the base map comes from OpenFreeMap tiles, so that service sees your browser's tile requests, as any image host would; it sets no cookie and needs no account."]],
  ["The app", ["Witness needs no account and never asks for your name, email, or location. To keep the weekly witness count honest, the app stores a random installation identifier and sends one witness event per installation and featured species; the server returns an aggregate count.", "The app also records, against that same random identifier, which of its own screens you reach — a paid page opened, a purchase started, finished, or cancelled, a species record opened, and which week it belonged to. One person makes Witness, and this is how he can tell which parts of it are used. These records carry no note text, no location, no contact details, and no payment details. That is the whole exchange.", "The App Store privacy label reads “Data Not Linked to You: Identifiers, Usage Data, Purchases”. Nothing is used for tracking or advertising, nothing is sold, and no third-party analytics or advertising SDK is in the app."]],
    ...
    <section className="py-12 md:py-16">
      <Container>
        ...
        <div className="mt-8 max-w-[62ch]">
          <Eyebrow className="text-sepia">Privacy · updated 16 September 2026</Eyebrow>
