...
const SECTIONS: [string, string[]][] = [
  ["This website", ["This website uses no account, email capture, analytics, advertising, or cookies. It serves public pages, original illustrations, and one audio sample. The map page draws its base map from OpenFreeMap tiles, so that service sees your browser's tile requests, as any image host would; it sets no cookie and needs no account. The same is true of the publication at community.witnessatlas.com, which adds an RSS feed; its email edition, where offered, is a link to a separate provider's page, and that provider holds the address under its own terms."]],
