...
const SECTIONS: [string, string[]][] = [
  ...
  ["The app", ["Witness needs no account and never asks for your name, email, or location. To keep the weekly witness count honest, the app stores a random installation identifier and sends one witness event per installation and featured species; the server returns an aggregate count.", "The app also records, against that same random identifier, which of its own screens you reach — a paid page opened, a purchase started, finished, or cancelled, a species record opened, and which week it belonged to. One person makes Witness, and this is how he can tell which parts of it are used. These records carry no note text, no location, no contact details, and no payment details. That is the whole exchange.", "The App Store privacy label reads “Data Not Linked to You: Identifiers, Usage Data”. Nothing is used for tracking or advertising, nothing is sold, and no third-party analytics or advertising SDK is in the app."]],
