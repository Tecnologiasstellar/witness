...
/** The App Store listing, live since 2026-09-24. Every store link, the Smart App Banner and the JSON-LD read these two. */
export const APP_STORE_ID = "6804311122";
export const APP_STORE_URL = `https://apps.apple.com/us/app/witness-endangered-species/id${APP_STORE_ID}`;
