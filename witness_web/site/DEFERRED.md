...
| Precise maps or locations | Never for sensitive species; only generalized, safety-reviewed geography. |
| Conservation outcome metrics | A real measurement design and evidence that distinguishes attention from outcomes. |

Nothing above is hidden or half-wired. The site states an unavailable or in-development condition instead.
