...
| Availability | Witness is published on the App Store as "Witness-Endangered Species" at `https://apps.apple.com/us/app/witness-endangered-species/id6804311122` (Apple ID 6804311122). It is free to download. witnessatlas.com links to it with Apple's unmodified black "Download on the App Store" badge (US-UK artwork on English pages, ES-MX on /es), a "Get the app" / "Obtén la app" header button, the footer "App Store" row and Safari's Smart App Banner, and says "Free on iPhone" / "Gratis en iPhone". Field Notes links to it with a "Download on the App Store" / "Descargar en el App Store" button and a footer row. | The iTunes lookup for id6804311122 returned resultCount 1 (version 1.0.0, first released 2026-09-24), and the listing URL returned 200; both checked 2026-09-25. The price is $0 in App Store Connect, confirmed by the founder on 2026-09-25; the store page's own offer reads price 0 and the listing shows Get. Hours after release the iTunes lookup still reported $9.99: it lags, so don't use it for price. Shipped in 0249536 (witnessatlas.com) and 51cac85 (Field Notes). | Confirmed | 2026-09-25 |
...
| Core promise | Witness is free to download. The featured story, sources, Witness action, count or explicit unavailable state, credible action, and private reflection are free, and are intended to remain free. | App Store Connect price $0, confirmed by the founder on 2026-09-25 (the store page's own offer reads price 0 and the listing shows Get); `../docs/ACCESS_AND_COMMERCE_SOURCE_OF_RECORD.md` section 5.1 for the intent | Confirmed (free today); "remain free" is product doctrine | 2026-09-25 |
