...
| Availability | Witness is published on the App Store as "Witness-Endangered Species" at `https://apps.apple.com/us/app/witness-endangered-species/id6804311122` (Apple ID 6804311122). witnessatlas.com links to it with Apple's unmodified black "Download on the App Store" badge (US-UK artwork on English pages, ES-MX on /es), a "Get the app" / "Obtén la app" header button, the footer "App Store" row and Safari's Smart App Banner. Field Notes links to it with a "Download on the App Store" / "Descargar en el App Store" button and a footer row. No store call to action says the app is free. | The iTunes lookup for id6804311122 returned resultCount 1 (version 1.0.0, first released 2026-09-24), and the listing URL returned 200; both checked 2026-09-25. Shipped in 0249536 (witnessatlas.com) and 51cac85 (Field Notes). Founder direction 2026-09-25: keep "free" out of store calls to action until the price is confirmed in App Store Connect. | Confirmed | 2026-09-25 |
