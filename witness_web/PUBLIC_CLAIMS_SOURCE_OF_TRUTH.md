...
| Website privacy | The current website has no analytics, cookies, email capture, advertising, or account. The map page requests its base-map tiles from openfreemap.org, as it would images from any host. | Repository audit | Confirmed locally | 2026-08-27 |
