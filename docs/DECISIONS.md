...
- Status: proposed 2026-09-16; needs founder acceptance (Alberto Villalpando). The deploy waits on the signed review in `docs/evidence/map-safety-review-2026-09.md`, which closes the "Sensitive species safety" release gate.
- Date: 2026-09-16
